...
//  Cinetopia
//
//  Created by Higor Jesus on 23/07/24.
//
...
class FavoriteMoviesViewController: UIViewController {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(FavoriteMovieCollectionViewController.self, forCellWithReuseIdentifier: "FavoriteMovieCollectionViewController")
...
extension FavoriteMoviesViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "FavoriteMovieCollectionViewController", for: indexPath) as? FavoriteMovieCollectionViewController else {
            fatalError("error to create FavoriteMovieCollectionViewController")
        }
...
extension FavoriteMoviesViewController: FavoriteMovieCollectionViewCellDelegate {
    func didSelectFavoriteButton(_ sender: UIButton) {
        ...
        guard let cell = sender.superview as? FavoriteMovieCollectionViewController else {
            return
        }
